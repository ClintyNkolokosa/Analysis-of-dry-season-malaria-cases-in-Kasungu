...
### Commented lines are producing errors: 1) "Error in ClosePol(x) : polygons require at least 4 points", 2) "Error in h(simpleError(msg, call)) : error in evaluating the argument 'x' in selecting a method for function 'addAttrToGeom': conversion from feature type sfc_GEOMETRY to sp is not supported" ###
