...
# plot(malire_new); points(zipatala_sp)
...
# grid <- GridTopology(x.min, ymin, c(2500, 2500), c(72, 48))
# 
# # Create points with the same coordinate system as the boundary
# gridpoints <- ___(___, proj4string = CRS(projection(___)))
# plot(gridpoints)
# 
# # Crop out the points outside the boundary
# cropped_gridpoints <- ___(gridpoints, ___)
