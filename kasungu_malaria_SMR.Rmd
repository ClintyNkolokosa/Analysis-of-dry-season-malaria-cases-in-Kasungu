...
# ====================================================
# Predictors	Incidence Rate   CI	             p
#                 Ratios	
# ----------------------------------------------------
# (Intercept)	  0.801	        0.791 – 0.810	  <0.001
# prop_pop_1km	1.025	        1.024  – 1.026	<0.001
# ----------------------------------------------------
# Observations	24
# R2 Nagelkerke	1.000
...
set.seed(123)
training_samples <- model_assessment_data$observed_2017 |>
  caret::createDataPartition(p = 0.8, list = FALSE)

train_data  <- model_assessment_data[training_samples, ]

test_data <- model_assessment_data[-training_samples, ]

# make predictions using the test data in order to evaluate the performance 
# of our regression model aka goodness-of-fit

# Make predictions
predictions <- model_1km_2017 |>
  predict(test_data)

# Model performance
# (a) Compute the prediction error, RMSE
caret::RMSE(predictions, test_data$observed_2017)

# (b) Compute R-square
caret::R2(predictions, test_data$observed_2017)
# [1] 0.8549051
