...
overall_malaria_incidence_rate_2017 <- sum(
  malaria_pop_by_catchment_2017$dr_2017) / sum(
    malaria_pop_by_catchment_2017$pop)

overall_malaria_incidence_rate_2017

overall_malaria_incidence_rate_2018 <- sum(
  malaria_pop_by_catchment_2018$dr_2018) / sum(
    malaria_pop_by_catchment_2018$pop)

overall_malaria_incidence_rate_2018

overall_malaria_incidence_rate_2019 <- sum(
  malaria_pop_by_catchment_2019$dr_2019) / sum(
    malaria_pop_by_catchment_2019$pop)

overall_malaria_incidence_rate_2019

overall_malaria_incidence_rate_2020 <- sum(
  malaria_pop_by_catchment_2020$dr_2020) / sum(
    malaria_pop_by_catchment_2020$pop)
