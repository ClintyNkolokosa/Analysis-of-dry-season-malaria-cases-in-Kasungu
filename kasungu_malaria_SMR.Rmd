...
# Inspect model data
model_assessment_data <- model_data_2017 |>
...
# 2017 -------------------------------------------------------------------------
training_samples_2017 <- model_assessment_data$observed_2017 |>
  caret::createDataPartition(p = 0.8, list = FALSE)

train_data_2017  <- model_assessment_data[training_samples_2017, ]

test_data_2017 <- model_assessment_data[-training_samples_2017, ]

# 2018 -------------------------------------------------------------------------
training_samples_2018 <- model_assessment_data$observed_2018 |>
  caret::createDataPartition(p = 0.8, list = FALSE) # see ?createDataPartition

train_data_2018 <- model_assessment_data[training_samples_2018, ]

test_data_2018 <- model_assessment_data[-training_samples_2018, ]

# 2019 -------------------------------------------------------------------------
training_samples_2019 <- model_assessment_data$observed_2019 |>
  caret::createDataPartition(p = 0.8, list = FALSE)

train_data_2019 <- model_assessment_data[training_samples_2019, ]

test_data_2019 <- model_assessment_data[-training_samples_2019, ]

# 2020 -------------------------------------------------------------------------
training_samples_2020 <- model_assessment_data$observed_2020 |>
  caret::createDataPartition(p = 0.8, list = FALSE)

train_data_2020 <- model_assessment_data[training_samples_2020, ]

test_data_2020 <- model_assessment_data[-training_samples_2020, ]
...
predictions_1km_2017 <- model_1km_2017 |>
  predict(test_data_2017)


# 2018 -------------------------------------------------------------------------
predictions_1km_2018 <- model_1km_2018 |>
  predict(test_data_2018)
