...
pop.density <- function(population.df){

# Convert to spatial object
sp <- as(malaria_pop_by_catchment_2017, "Spatial")

# Calculate area of catchment polygon in square kilometres
sp$area_sqkm <- round(rgeos::gArea(sp, byid = TRUE) / (1000 * 1000))

# Calculate population density
sp$pop_density <- round(sp$pop / sp$area_sqkm)
}
