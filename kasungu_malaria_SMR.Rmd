...
We do this by comparing what we `observe` (O) with what we would `expect` (E) if the risk of malaria was equal throughout Kasungu. The SMR of catchment *i* can be calculated as follows:
$$SMR_i = \frac{O_i}{E_i}$$
