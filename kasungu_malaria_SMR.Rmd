...
regression_table_1km <- gtsummary::tbl_regression(multivariate_1km, exponentiate = TRUE)
...
regression_table_2km <- gtsummary::tbl_regression(multivariate_2km, exponentiate = TRUE)
...
regression_table_3km <- gtsummary::tbl_regression(multivariate_3km, exponentiate = TRUE)
