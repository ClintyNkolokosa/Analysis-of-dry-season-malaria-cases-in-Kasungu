...
We also compare the effect of removing intercept from the multiple linear regression. Mathematically, $𝜷_0 = 0$. Hence our multivariate model without intercept can be written as: $$ ln (E(y)) = {𝜷_1} {x_i}_{1} + ln(𝒆_𝒊),  i = 1,2,3,⋯,n$$
...
multivariate_1km_no_intercept <- glm(observed_cases~-1+prop_pop_1km+year,
                                     offset = log(expected_cases),
                                     data = model_data, 
                                     family = poisson(link = "log"))
summary(multivariate_1km_no_intercept)
...
# Check effect of removing intercept
multivariate_2km_no_intercept <- glm(observed_cases~-1+prop_pop_2km+year,
                                     offset = log(expected_cases),
                                     data = model_data, 
                                     family = poisson(link = "log"))
...
# Check effect of removing intercept
multivariate_3km_no_intercept <- glm(observed_cases~-1+prop_pop_3km+year,
                                     offset = log(expected_cases),
                                     data = model_data, 
                                     family = poisson(link = "log"))
