...
`Pseudo R-squared goodness-of-fit` measure for count data in Poisson regression which is nonlinear computed using deviance statistics:
...
predictions_2km_2017 <- model_2km_2017 |>
  stats::predict(test_data_2017, type = "response")

# 2018 
predictions_1km_2018 <- model_1km_2018 |>
  stats::predict(test_data_2018, type = "response")
...
predictions_1km_2019 <- model_1km_2019 |>
  stats::predict(test_data_2019, type = "response")
...
predictions_1km_2020 <- model_1km_2020 |>
  stats::predict(test_data_2020, type = "response")
...
# The goodness of fit of the Poisson regression model has been expressed by 
# widely variants of pseudo R squared statistics, most of which are based on 
...
# the "true R2". -----------------------------------------------------------------
# 2017 
DescTools::PseudoR2(model_1km_2017)

DescTools::PseudoR2(model_2km_2017)

DescTools::PseudoR2(model_1km_2018)

round(DescTools::PseudoR2(model_2km_2018), 2)

round(DescTools::PseudoR2(model_1km_2019), 2)

round(DescTools::PseudoR2(model_2km_2019, "all"), 2)

round(DescTools::PseudoR2(model_1km_2020, "all"), 2)
