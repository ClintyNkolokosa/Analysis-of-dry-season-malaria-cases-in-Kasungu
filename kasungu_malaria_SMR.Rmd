...
```{r, message=FALSE, fig.height=15, fig.width=11, fig.cap='Fig 10. How well the percentage of catchment population living around water bodies explain observed malaria incidence'}
...
plot(catchment_neighbours, coords, col = "blue", add = T)}
