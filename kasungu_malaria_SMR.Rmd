...
```{r, message=FALSE, fig.height=15, fig.width=10, fig.cap='Fig. 12. How well the percentage of catchment population living around water bodies explain observed malaria incidence'}
