...
# In the absence of overdispersion, we expect the dispersion parameter estimate to be 1.0. The estimated dispersion parameter here is much larger than 1.0 (594.1947) indicating overdispersion (extra variance) that should be accounted for. 
