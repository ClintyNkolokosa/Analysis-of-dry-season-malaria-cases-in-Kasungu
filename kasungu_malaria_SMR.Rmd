...
create.smr.map <- function(smr.data, 
  ...
  # smr.category.list <- c("<0.49", "0.50 to 0.99", "1.00", "1.10 to 1.49", "1.50 to 1.99", 
  #                        "2.00 to 2.49", "2.50 to 2.99", "3.00 & above")

  smr.category.list <- c("<0.50", "0.51 to 0.75", "0.76 to 0.99", "1.00", 
                         "1.10 to 1.24", "1.25 to 1.49", "1.50 & above")
  ...
  smr.palette <- c("#33a6fe", "#65bafe", "#98cffe", "#cbe6fe", "#dfeffe", 
                   "#fef9f9", "#fed5d5", "#feb1b1", "#fe8e8e", "#fe6a6a",
                   "#fe4646", "#fe2424", "#fe0000")
