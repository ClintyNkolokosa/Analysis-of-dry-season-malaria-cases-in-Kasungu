...
# Note to self: do LOOCV(Leave One Out Cross-Validation) and k-fold Cross Validation
...
# Prep data
prep.spatial.dependency.data <- function(df_2017, df_2018, df_2019, df_2020){
  df_2017 |>
    dplyr::rename(observed_2018 = dr_2018,
                  observed_2019 = dr_2019,
                  observed_2020 = dr_2020,
                  SMR_2017 = SMR) |> 
    dplyr::select(rowID, SMR_2017)
  df_2018 |> 
