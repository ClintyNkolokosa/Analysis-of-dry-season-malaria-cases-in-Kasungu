...
### Kasungu health-care facilities and their health facility catchment areas
...
### Calculate the Standard Morbidity Ratio of malaria incidences for each catchment area 

The standardised morbidity ratio (SMR) compares the risk of morbidity in a population of interest with that of a standard population. In this case, our interest is to find out whether the number of dry season malaria cases in each catchment area are greater than we would expect given the malaria rate for the entire Kasungu district.
...
```{r, message=FALSE, warning = FALSE, fig.height = 9, fig.width = 11, fig.cap='Fig 8. Proportionof catchment living within in around water bodies'}
