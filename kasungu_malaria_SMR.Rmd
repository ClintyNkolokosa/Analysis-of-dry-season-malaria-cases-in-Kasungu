...
create.waterbody.buffer <- function(waterbody, distance, catchment){
  ...
  sf::st_intersects(buffer_intersect_sf, catchment)
  
  # Make the assumption that the attribute is constant throughout the geometry
  sf::st_agr(buffer_intersect_sf) = "constant"
  
  sf::st_agr(catchment) = "constant"
  
  return(out = buffer_intersect_sf)
}
...
# Map the buffers
create.buffer.map <- function(buffers, boundary, title = NA){
...
# Invoking the function
# For 2017 -------------------------------------------------------------------------------
buffer_1km_2017_map <- create.buffer.map(buffer_1km_2017, 
                                         malire_new, 
                                         title = "2017: 1km Buffers")

buffer_2km_2017_map <- create.buffer.map(buffer_2km_2017, 
                                         malire_new, 
                                         title = "2017: 2km Buffers")

buffer_3km_2017_map <- create.buffer.map(buffer_3km_2017, 
                                         malire_new, 
                                         title = "2017: 3km Buffers")

# For 2018 --------------------------------------------------------------------------------
buffer_1km_2018_map <- create.buffer.map(buffer_1km_2018, 
                                         malire_new, 
                                         title = "2018: 1km Buffers")

buffer_2km_2018_map <- create.buffer.map(buffer_2km_2018, 
                                         malire_new, 
                                         title = "2018: 2km Buffers")

buffer_3km_2018_map <- create.buffer.map(buffer_3km_2018, 
                                         malire_new, 
                                         title = "2018: 3km Buffers")

# For 2019 ---------------------------------------------------------------------------------
buffer_1km_2019_map <- create.buffer.map(buffer_1km_2019, 
                                         malire_new, 
                                         title = "2019: 1km Buffers")

buffer_2km_2019_map <- create.buffer.map(buffer_2km_2019, 
                                         malire_new, 
                                         title = "2019: 2km Buffers")

buffer_3km_2019_map <- create.buffer.map(buffer_3km_2019, 
                                         malire_new, 
                                         title = "2019: 3km Buffers")

# For 2020 --------------------------------------------------------------------------------
buffer_1km_2020_map <- create.buffer.map(buffer_1km_2020, 
                                         malire_new, 
                                         title = "2020: 1km Buffers")

buffer_2km_2020_map <- create.buffer.map(buffer_2km_2020, 
                                         malire_new, 
                                         title = "2020: 2km Buffers")

buffer_3km_2020_map <- create.buffer.map(buffer_3km_2020, 
                                         malire_new, 
                                         title = "2020: 3km Buffers")
