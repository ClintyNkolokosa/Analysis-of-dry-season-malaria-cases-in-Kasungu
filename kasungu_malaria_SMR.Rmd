...
bind.model.data <- function(data_2017, data_2018, data_2019, data_2020){
  
  tibble_2017 <- data_2017 |> 
    dplyr::as_tibble() |> 
    dplyr::rename(`2017` = observed_2017,
                  expected = expected_2017) |> 
    dplyr::select(-geometry, -prop_pop_3km, -fid, -DN, -X, -SMR, -pop_2017,
                  -dr_2018, -dr_2019, -dr_2020)
                  
  tibble_2018 <- data_2018 |> 
    dplyr::as_tibble() |>
    dplyr::rename(`2018` = observed_2018,
                  expected = expected_2018) |> 
    dplyr::select(-c(geometry, prop_pop_3km, fid, DN, X, SMR, pop_2018,
                     dr_2017, dr_2019, dr_2020))
  
  tibble_2019 <- data_2019 |> 
    dplyr::as_tibble() |>
    dplyr::rename(`2019` = observed_2019,
                  expected = expected_2019) |> 
    dplyr::select(-c(geometry, prop_pop_3km, fid, DN, X, SMR, pop_2019,
                     dr_2017, dr_2018, dr_2020))
  
  tibble_2020 <- data_2020 |> 
    dplyr::as_tibble() |>
    dplyr::rename(`2020` = observed_2020,
                  expected = expected_2020) |> 
    dplyr::select(-c(geometry, prop_pop_3km, fid, DN, X, SMR, pop_2020,
                     dr_2017, dr_2018, dr_2019))
  
  model_data <- rbind(tibble_2017, tibble_2018, tibble_2019, tibble_2020)
  
  # model_data <- dplyr::bind_rows(tibble_2017, tibble_2018, tibble_2019, tibble_2020)|> 
...
# Invoking function ------------------------------------------------------------
model_data <- bind.model.data(model_data_2017, model_data_2018, 
