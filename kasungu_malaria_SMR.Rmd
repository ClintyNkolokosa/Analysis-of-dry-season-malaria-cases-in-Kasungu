...
with(zipatala_aggregated,
     {dr_2017[which(Names == "Kasungu District Hospital")] <- dr_2017[which(
       Names == "Kasungu District Hospital")] + dr_2017[which(
         Names == "Kasalika Health Centre")]})
...
Here, we evaluate how well the model is predicting the outcome of a new test data that have not been used to build the model.

Two important metrics that are used to assess the performance of the predictive regression model:
