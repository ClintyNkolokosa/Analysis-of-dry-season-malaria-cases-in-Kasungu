...
zipatala_aggregated$dr_2017[which(
  zipatala_aggregated$Names == "Anchor Farm")] <- zipatala_aggregated$dr_2017[which(
    zipatala_aggregated$Names == "Anchor Farm")] + zipatala_aggregated$dr_2017[which(
      zipatala_aggregated$Names == "Santhe Health Centre")]

zipatala_aggregated$dr_2018[which(
  zipatala_aggregated$Names == "Anchor Farm")] <- zipatala_aggregated$dr_2018[which(
    zipatala_aggregated$Names == "Anchor Farm")] + zipatala_aggregated$dr_2018[which(
      zipatala_aggregated$Names == "Santhe Health Centre")]

zipatala_aggregated$dr_2019[which(
  zipatala_aggregated$Names == "Anchor Farm")] <- zipatala_aggregated$dr_2019[which(
    zipatala_aggregated$Names == "Anchor Farm")] + zipatala_aggregated$dr_2019[which(
      zipatala_aggregated$Names == "Santhe Health Centre")]

zipatala_aggregated$dr_2020[which(
  zipatala_aggregated$Names == "Anchor Farm")] <- zipatala_aggregated$dr_2020[which(
    zipatala_aggregated$Names == "Anchor Farm")] + zipatala_aggregated$dr_2020[which(
      zipatala_aggregated$Names == "Santhe Health Centre")]
...
# st_write(health_facility_aggr_sf, "data/zipatala_aggregated_july.shp")
