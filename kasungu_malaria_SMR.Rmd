...
```{r, message=FALSE, fig.height = 7, fig.width = 7, fig.cap = 'Fig. 2: Estimated population in Kasungu health facility catchment areas'}
...
```{r, message=FALSE, fig.height=10, fig.width=7, fig.cap= 'Fig 3: Observed and expected malaria incidence by health facility catchment area, Kasungu'}
...
```{r, message=FALSE, fig.height = 7, fig.width = 7, fig.cap = 'Fig. 4: Standard Morbidity Rate by health facility catchment'}
