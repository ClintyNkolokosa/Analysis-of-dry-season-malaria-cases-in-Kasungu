...
Here we apply a `quassi-Poisson` and `negative binomial` regression models to the interaction model, which we have observed that it suffers from overdispersion issues under regular `Poisson` regression.
