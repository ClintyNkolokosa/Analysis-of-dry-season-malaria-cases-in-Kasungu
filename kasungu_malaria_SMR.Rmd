...
zipatala$dr_2020[which(
  zipatala$Names == "Mziza Health Centre")] <- zipatala$dr_2020[which(
    zipatala$Names == "Mziza Health Centre")] + zipatala$dr_2020[which(
      zipatala_d$Names == "Bua Health Centre")]

zipatala$dr_2017[which(
  zipatala$Names == "Anchor Farm")] <- zipatala$dr_2017[which(
    zipatala$Names == "Anchor Farm")] + zipatala$dr_2017[which(
      zipatala_$Names == "Santhe Health Centre")]

zipatala$dr_2018[which(
  zipatala$Names == "Anchor Farm")] <- zipatala$dr_2018[which(
    zipatala$Names == "Anchor Farm")] + zipatala$dr_2018[which(
      zipatala$Names == "Santhe Health Centre")]
