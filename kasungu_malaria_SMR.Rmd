...
# Pivot longer -----------------------------------------------------------------
dry_season_malaria_pivot <- dry_season_malaria_2017_2020 %>% 
  dplyr::rename(`2017` = dr_2017,
                `2018` = dr_2018,
                `2019` = dr_2019,
                `2020` = dr_2020) %>% 
  tidyr::pivot_longer(c(`2017`, `2018`, `2019`, `2020`),
                      names_to = 'year',
...
# Run a Conditional Autoregessive (CAR) model, which allows us to incorporate 
...
# Now we can fit the model. The spatial effect is called using the adjacency function which # requires the grouping factor (i.e. the rowID of each catchment area)

CAR_model_1km_2017 <- spaMM::fitme(observed_2017~prop_pop_1km+
                                   offset(log(expected_2017)),
