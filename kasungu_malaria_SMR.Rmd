...
# Create function to tidy and bind the SMR and proportion of -------------------
...
scatter_1km_2017 <- ggplot2::ggplot(
  ...
  stat_smooth(method = "lm",
              ...
              se = FALSE,
              size = 1)+
  labs(x = "Percentage of catchment population living in 1km buffers",
       y = "Standardised morbidity ratio",
       title = "Relation between SMR and living near waterbodies")
...
scatter_2km_2017 <- ggplot2::ggplot(
  ...
  stat_smooth(method = "lm",
              ...
              se = FALSE,
              size = 1)+
  labs(x = "Percentage of catchment population living in 2km buffers",
       y = "Standardised morbidity ratio",
       title = "Relation between SMR and living near waterbodies")
...
scatter_3km_2017 <- ggplot2::ggplot(
  ...
  stat_smooth(method = "lm",
              ...
              se = FALSE,
              size = 1)+
  labs(x = "Percentage of catchment population living in 3km buffers",
       y = "Standardised morbidity ratio",
       title = "Relation between SMR and living near waterbodies")
