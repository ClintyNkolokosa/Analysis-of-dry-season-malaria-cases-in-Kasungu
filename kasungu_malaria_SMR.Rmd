...
estimate.buffer.pop <- function(catchment.population, buffers, catchment.area){
  ...
  buffer_pop <- sf::st_drop_geometry(buffer_pop_aggregated) |>
    merge(catchment.area, buffer_pop_aggregated, by = 'DN', all.x = TRUE)
...
Two important metrics that have been used to assess the performance of the predictive regression model:
