...
model_data_2017_longer <- as.data.frame(model_data_2017) |> 
  dplyr::mutate(malaria_2017 = observed_2017) |> 
  dplyr::select(rowID, Names, observed_2017, dr_2018, 
                dr_2019, dr_2020, malaria_2017,
...
# Model fitting ----------------------------------------------------------------
multivariate_1km_2017 <- glm(malaria_2017~1+prop_pop_1km+year+offset(log(expected_2017)),
...
multivariate_2km_2017 <- glm(malaria_2017~1+prop_pop_2km+year+offset(log(expected_2017)),
                             data = model_data_2017_longer, family = 'poisson')

summary(multivariate_2km_2017)
sjPlot::tab_model(multivariate_2km_2017)

multivariate_3km_2017 <- glm(malaria_2017~1+prop_pop_3km+year+offset(log(expected_2017)),
                             data = model_data_2017_longer, family = 'poisson')
