...
`Residual standard error` (`RSE`), and `R-squared` (`R2`)  metrics tell how well the model fits to our data. 
...
# Observations	24
# R2 Nagelkerke	1.000
# An (adjusted) R^2 that is close to 1 indicates that a large proportion of the 
...
RMSE(predictions, test_data$observed_2017)
