...
```{r, message=FALSE, fig.width=10, fig.cap= 'Fig 12. Poisson distribution of dry season malaria cases. Clearly, the data is not in the form of a bell curve like in a normal distribution. Many health facilities reported very few malaria cases. A few health facilities have a large number of cases making for a distribution that appears to be far from normal. Therefore, Poisson regression should be used to model our dry season malaria data.'}
...
gridExtra::grid.arrange(histogram_2017, histogram_2018,
                        histogram_2019, histogram_2020)
