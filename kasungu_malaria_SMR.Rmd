...
SMR_2017_sp <- as(SMR_2017, "Spatial")

mapview::mapview(SMR_2017_sp, zcol = "SMR")

raster::spplot(SMR_2017_sp, zcol = "SMR")
...
# observed malaria cases = 7.204975 + 0.074927 * percentage of catchment population living near dam 
...
#
# For example:
#   for a buffer population equal zero, we can expect 7 malaria cases. 
#   for a buffer population equal 1000, we can expect  round(7.2 + 0.07* 1000) = 77 malaria cases.
...
model_2km_2017 <- glm(observed_2017~prop_pop_2km, offset(log(expected_2017)),
                      data = model_data_2017, family = 'poisson')

summary(model_2km_2017)
sjPlot::tab_model(model_2km_2017, digits = 3, digits.re = 3)

model_3km_2017 <- glm(observed_2017~prop_pop_3km, offset(log(expected_2017)),
                      data = model_data_2017, family = 'poisson')
