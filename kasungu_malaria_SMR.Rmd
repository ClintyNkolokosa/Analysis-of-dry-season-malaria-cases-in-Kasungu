...
`Residual standard error` (`RSE`), and `R-squared` (`R2`)  metrics tell how well the model fits to our data. An (adjusted) `R2` that is close to 1 indicates that a large proportion of the variability in the outcome has been explained by the regression model. A number near 0 indicates that the regression model did not explain much of the variability in the outcome.
...
Here, we evaluate how well the `Poisson regression` model is predicting the outcome of a new test data that have not been used to build the model i.e how close the predicton is close to the real value.
...
# Check model assumptions, like check_collinearity(), check_normality() or 
...
# Compute indices of model performance for the regression models
performance::model_performance(model_1km_2017)

performance::model_performance(model_2km_2017)

performance::model_performance(model_1km_2018)

performance::model_performance(model_2km_2018)

performance::model_performance(model_1km_2019)

performance::model_performance(model_2km_2019)

performance::model_performance(model_1km_2020)

performance::model_performance(model_2km_2020)


# Compare the quality of the models --------------------------------------------
model_comparison <- performance::compare_performance(model_1km_2017, model_2km_2017, model_1km_2018,
                                                     model_2km_2018, model_1km_2019, model_2km_2019,
                                                     model_1km_2020, model_2km_2020, rank = TRUE)
...
plot(performance::compare_performance(model_1km_2017, model_2km_2017, model_1km_2018,
                                      model_2km_2018, model_1km_2019, model_2km_2019,
                                      model_1km_2020, model_2km_2020, rank = TRUE))
```
