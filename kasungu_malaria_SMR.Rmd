...
merge.model.data <- function(data_2017, data_2018, data_2019, data_2020){
  ...
  data_2017 <- data_2017 |> 
    ...
    dplyr::select(-c(geometry, prop_pop_3km, fid, DN, X
                     dr_2018, dr_2019, dr_2020)
                  
  data_2018 <- data_2018 |> 
    dplyr::rename(prop_pop_1km_2018 = prop_pop_1km.
                  prop_pop_2km_2018 = prop_pop_1km) |> 
    dplyr::select(-c(Names, geometry, prop_pop_3km, fid,
                     DN, X, dr_2017, dr_2019, dr_200))
  
  data_2019 <- data_2019 |> 
    dplyr::rename(prop_pop_1km_2019 = prop_pop_1km,
                  prop_pop_2km_2019 = prop_pop_2km) |> 
    dplyr::select(-c(Names, geometry, prop_pop_3km, fid,
                     DN, X, dr_2017, dr_2018, dr_200))
  
  tibble_2017 <- dplyr::as_tibble(data_2017)
  
  tibble_2018 <- dplyr::as_tibble(data_2018)
  
  tibble_2019 <- dplyr::as_tibble(data_2019)
  
  tibble_2020 <- dplyr::as_tibble(data_2020)
