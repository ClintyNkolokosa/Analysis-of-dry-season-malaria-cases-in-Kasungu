...
```{r, message=FALSE, fig.height=5, fig.width=10, fig.cap='Fig. 3. How well the percentage of catchment population living around water bodies explain observed malaria incidence'}
