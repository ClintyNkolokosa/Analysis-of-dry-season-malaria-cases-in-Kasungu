...
104 different samples were used to build 104 models. Each model used 3 predictor variables.
    ...
    The resampling method we used to generate the 96 samples was Leave-One-Out Cross Validation.
